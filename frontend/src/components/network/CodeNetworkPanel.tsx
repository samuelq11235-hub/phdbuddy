    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Los códigos que co-ocurren en la misma cita aparecen conectados. El grosor de la
          conexión es el número de citas compartidas; el tamaño del nodo es el uso total del código.
        </p>
      </div>
...
function buildLayout(
  codes: Awaited<ReturnType<typeof useCodes>["data"]> extends infer T
    ? T extends Array<infer R>
      ? R[]
      : never
    : never,
  cooccurrence: Awaited<ReturnType<typeof useCodeCooccurrence>["data"]> extends infer T
    ? T extends Array<infer R>
      ? R[]
      : never
    : never
